...
CREATE TABLE `preset_playlist` (
  ...
  CONSTRAINT `user_id` FOREIGN KEY (`preset_playlist_id`) REFERENCES `users` (`user_id`)
...
INSERT INTO `UserLikes` VALUES (3,1),(4,18),(11,21),(20,1),(20,23);
...
-- Dump completed on 2024-04-13 11:25:28
